...
def CreateDatacard(fname, outpath=outpath, oname=output):
  ...
  if year=='2016': 
    lumiUnc = 0.012
    lumiUncc1= 0.006 #2016:0.6, 2017: 0.9, 2018:2.0
    lumiUncc2= 0.0 #2016:0.0, 2017: 0.6, 2018:0.2
  if year=='2016apv':
    lumiUnc = 0.012
    lumiUncc1= 0.006 #2016:0.6, 2017: 0.9, 2018:2.0
    lumiUncc2= 0.0 #2016:0.0, 2017: 0.6, 2018:0.2
  if year=='2017':
    lumiUnc = 0.02
    lumiUncc1= 0.009 #2016:0.6, 2017: 0.9, 2018:2.0
    lumiUncc2= 0.006 #2016:0.0, 2017: 0.6, 2018:0.2
  if year=='2018':
    lumiUnc = 0.015
    lumiUncc1= 0.02 #2016:0.6, 2017: 0.9, 2018:2.0
    lumiUncc2= 0.002 #2016:0.0, 2017: 0.6, 2018:0.2
  '''
  lumiUnc = 0.02 #2016:1.2, 2017:2.0, 2018: 1.5
  lumiUncc1= 0.009 #2016:0.6, 2017: 0.9, 2018:2.0
  lumiUncc2= 0.006 #2016:0.0, 2017: 0.6, 2018:0.2
  '''
  #bkg =  ['tW', 'WJets', 'QCD', 'DY']
  ...
  verbose=1
  d = Datacard(fname, signal, bkg, lumiUnc, lumiUncc1, lumiUncc2, norm, sList, nSpaces=12, verbose=verbose,year=year) #sList--> systList incluyo year
