...
names = {
  'lepSF_muon' : 'Muon efficiencies',
  'lepSF_elec' : 'Electron efficiencies',
...
categoriesPDF = {'channel':'em', 'level': 'g2jetsg1b'}#, 'syst':'norm'} 
...
'''
years=0
#nota: primero coge 2018 y va bajando 
if years=='2016': 
  lumi==16.81
if years=='2016apv':
  lumi==19.52
...
#experimental = ['lepSF_muon', 'lepSF_elec','trigSF','btagging','JER', 'PU', 'PreFiring','JES_FlavorQCD', 'JES_BBEC1', 'JES_Absolute', 'JES_RelativeBal', 'JES_RelativeSample']
modeling = ['hdamp','UE','ISR','FSR'] # ['UE', 'hdamp', 'ISR', 'FSR']'mtop'
#modeling=[]
x = xsec('tt', 0.025, {'tW':0.10,'Non-prompt': 0.3, 'DY':0.2, 'VV':0.3, 'ttX': 0.3}, plotter=p, verbose=4, thxsec=833.9, experimental=experimental, modeling=modeling, categories=categories)
...
path_gen = '/nfs/fanae/user/jorgeat/Documentos/tfm/cafea/histos/TTTo2L2Nu_gen_2016.pkl.gz'
